...
const WidgetWithTableLg = (props) => {
  ...
  }, [props.data.tableData, props.isRefresh]);

  return (
    <div
      className="flex w-full  p-3 rounded-xl flex-col align-top justify-start gap-y-3"
...
export default WidgetWithTableLg;
